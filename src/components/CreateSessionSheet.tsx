      ...
      <SheetContent side="right" className="w-full sm:max-w-md bg-card border-border overflow-y-auto">
        ...
        <div className="space-y-6 px-4 pb-8">
          ...
          <Button
            ...
            className="w-full h-14 bg-brand text-white hover:bg-brand-dark rounded-2xl font-extrabold uppercase tracking-tighter italic text-base shadow-xl shadow-brand/20"
          >
